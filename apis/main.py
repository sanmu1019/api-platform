...
from apis.extra.route import router as extra_router
...
from apis.music.route import router as music_router
...
from apis.wxsph.route import router as wxsph_router
...
def register_api_routers(app: FastAPI) -> None:
    ...
    app.include_router(wxsph_router)
